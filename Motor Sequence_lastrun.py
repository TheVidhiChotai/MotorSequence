...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Riddhi\\Documents\\Lab in Psychology\\Motor Sequence_lastrun.py',
...
trials = data.TrialHandler(nReps=24.0, method='sequential', 
    ...
    trialList=data.importConditions('T4 Motor Sequence/sequence_con.csv'),
